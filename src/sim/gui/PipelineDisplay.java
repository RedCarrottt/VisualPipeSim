...
public class PipelineDisplay extends JComponent
{
	...
	// Paths
	private final static Color PATH_COLOUR = new Color(18,221,25);
	...
	public PipelineDisplay(Instruction[] program)
	{
		...
		ImageIcon imageIcon = new ImageIcon("images/arch.png");
...
/*		addMouseMotionListener(new MouseMotionListener()
	...
	public void paintComponent(Graphics g)
	{
		...
		g.drawString(String.format("r%01X",	signals.ex_rAddA),	480,	140);
